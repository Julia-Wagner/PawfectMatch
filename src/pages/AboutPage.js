                ...
                <Col className="py-2 p-0 p-lg-2">
                    <Container className={`p-4 ${appStyles.Content}`}>
                        ...
                        <ul className={styles.UnorderedList}>
                            ...
                            <li className={styles.ListItem}>
                                <a href="https://www.linkedin.com/in/julia-wagner-0ba4461a8" className="footer-icon" target="_blank" rel="noreferrer noopener" aria-label="open my LinkedIn profile in a new tab">
                                    <svg className={styles.SocialIcon} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
